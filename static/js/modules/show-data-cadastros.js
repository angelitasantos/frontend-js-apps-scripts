...
const AppScriptGoogleCadastros = "AKfycbx3GSXPa4QNJlzXzzOyCfSlfN9QWeZZnvPFkpS0GlT7_c1KVyfyXOHQHLq4ABfKT3Z8-g";
...
function MaxItens() {
    $.getJSON("https://script.google.com/macros/s/" + AppScriptGoogleCadastros + "/exec?page=maxItem",
        function (data) {
...
function SearchEditItens(pNo = "") {
    ...
    $.getJSON("https://script.google.com/macros/s/" + AppScriptGoogleCadastros + "/exec?page=searchItem&no=" + no,
        function (data) {
            if (data == "NOT FOUND") {
...
function ShowAllDataItens() {
    ...
    $(document).ready(function () {
        ...
        $.getJSON("https://script.google.com/macros/s/" + AppScriptGoogleCadastros + "/exec?page=tabPreco",
            function (data) {
...
function MaxParceiro() {
    $.getJSON("https://script.google.com/macros/s/" + AppScriptGoogleCadastros + "/exec?page=maxParceiro",
        function (data) {
...
function SearchEditParceiros(pNo = "") {
    ...
    $.getJSON("https://script.google.com/macros/s/" + AppScriptGoogleCadastros + "/exec?page=searchParceiro&no=" + no,
        function (data) {
            if (data == "NOT FOUND") {
                alert('Número Não Encontrado!!!');
            }
...
function ShowAllDataParceiros() {
    ...
    $(document).ready(function () {
        ...
        $.getJSON("https://script.google.com/macros/s/" + AppScriptGoogleCadastros + "/exec?page=allParceiro",
            function (data) {
