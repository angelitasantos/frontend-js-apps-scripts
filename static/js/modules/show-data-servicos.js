...
const GoogleRegistros = "AKfycbxDB720Ipcduwv-BmKBavBmb-ZPVBqqShGgMyE11NzYAZ12xSDLnEHAy55Oab0G-IyWmA";
// script file sig-servicos
// https://script.google.com/macros/s/AKfycbxDB720Ipcduwv-BmKBavBmb-ZPVBqqShGgMyE11NzYAZ12xSDLnEHAy55Oab0G-IyWmA/exec
            ...
            if (data == "NOT FOUND") {
                ...
                $.each(record, function (key, value) {
                    if (i == 0) {
                        ...
                        document.getElementsByName("status_order")[0].value = value[3];
                        ...
                        document.getElementsByName("fgst")[0].value = value[23];
                        document.getElementsByName("fdiscount")[0].value = value[24];
                    }
                    else {
                        if (i > 1) BtnAdd();
                        ...
                        document.getElementsByName("rate")[i].value = value[31];
